...
<!-- md-trans-meta sourceCommit=unknown translatedAt=2026-05-20T04:17:50.904Z pushedAt=2026-05-20T09:58:07.882Z -->
...
<th class="cellrowborder" valign="top" width="24.709999999999997%" id="mcps1.2.4.1.2"><p id="p546314712159"><a name="p546314712159"></a><a name="p546314712159"></a>Interface</p>
</th>
<th class="cellrowborder" valign="top" width="61.57%" id="mcps1.2.4.1.3"><p id="p846354718154"><a name="p846354718154"></a><a name="p846354718154"></a>Description</p>
</th>
</tr>
</thead>
<tbody><tr id="row164631047141520"><td class="cellrowborder" rowspan="2" valign="top" width="13.719999999999999%" headers="mcps1.2.4.1.1 "><p id="p1740014991719"><a name="p1740014991719"></a><a name="p1740014991719"></a>Calling msOpGen Project</p>
</td>
...
<td class="cellrowborder" valign="top" width="61.57%" headers="mcps1.2.4.1.3 "><p id="p10463194791519"><a name="p10463194791519"></a><a name="p10463194791519"></a>Calls the user's tiling function.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p738182655420"><a name="p738182655420"></a><a name="p738182655420"></a>Generates an instance that can call the user's Kernel function.</p>
</td>
</tr>
<tr id="row1146304781520"><td class="cellrowborder" rowspan="5" valign="top" width="13.719999999999999%" headers="mcps1.2.4.1.1 "><p id="p840054919173"><a name="p840054919173"></a><a name="p840054919173"></a>Auto Tuning</p>
</td>
...
<td class="cellrowborder" valign="top" width="61.57%" headers="mcps1.2.4.1.3 "><p id="p946344718154"><a name="p946344718154"></a><a name="p946344718154"></a>Traverses the search space, tries different parameter combinations, and displays the runtime of each combination along with the optimal combination.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p8464164721515"><a name="p8464164721515"></a><a name="p8464164721515"></a>Traverses the search space, tries different parameter combinations, and displays the runtime of each combination along with the optimal combination.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="p11177221143010"><a name="p11177221143010"></a><a name="p11177221143010"></a>Compiles the code and returns an executable object.</p>
</td>
</tr>
</tbody>
</table>
...
<table><thead align="left"><tr id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_row53871743113510"><th class="cellrowborder" valign="top" width="17.16%" id="mcps1.1.5.1.1"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p1438834363520"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p1438834363520"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p1438834363520"></a>Parameter Name</p>
</th>
<th class="cellrowborder" valign="top" width="10.05%" id="mcps1.1.5.1.2"><p id="zh-cn_topic_0000001693276536_p1769255516412"><a name="zh-cn_topic_0000001693276536_p1769255516412"></a><a name="zh-cn_topic_0000001693276536_p1769255516412"></a>Input/Output</p>
</th>
<th class="cellrowborder" valign="top" width="7.5200000000000005%" id="mcps1.1.5.1.3"><p id="p108901947143015"><a name="p108901947143015"></a><a name="p108901947143015"></a>Required</p>
</th>
<th class="cellrowborder" valign="top" width="65.27%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p1239865692418"><a name="p1239865692418"></a><a name="p1239865692418"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p7393552113017"><a name="p7393552113017"></a><a name="p7393552113017"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p1144119163112"><a name="p1144119163112"></a><a name="p1144119163112"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.27%" headers="mcps1.1.5.1.4 "><p id="p1460753613473"><a name="p1460753613473"></a><a name="p1460753613473"></a>Fills in tensor information in the order of the Kernel function input arguments. If a parameter is not used, pass None as a placeholder in the corresponding position.</p>
<p id="p3487952194619"><a name="p3487952194619"></a><a name="p3487952194619"></a>Data Type: list. Each element must be a tensor or list[tensor]. If format or ori_format is not explicitly specified in inputs_info, all tensors default to ND format.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p311131173914"><a name="p311131173914"></a><a name="p311131173914"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p108911747123017"><a name="p108911747123017"></a><a name="p108911747123017"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.27%" headers="mcps1.1.5.1.4 "><p id="p1584018241204"><a name="p1584018241204"></a><a name="p1584018241204"></a>Fills in tensor information in the order of the Kernel function input arguments. If a parameter is not used, pass None as a placeholder in the corresponding position.</p>
<p id="p1584002417011"><a name="p1584002417011"></a><a name="p1584002417011"></a>Data Type: list. Each element must be a tensor or list[tensor]. If format or ori_format is not explicitly specified in inputs_info, all tensors default to ND format.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p19448137102917"><a name="p19448137102917"></a><a name="p19448137102917"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p4454173572815"><a name="p4454173572815"></a><a name="p4454173572815"></a>Optional parameter.</p>
</td>
...
<div class="note" id="note671620416381"><a name="note671620416381"></a><a name="note671620416381"></a><span class="notetitle"> NOTE: </span><div class="notebody"><p id="p96594417491"><a name="p96594417491"></a><a name="p96594417491"></a>This input parameter has a constraint relationship with inputs:</p>
<a name="ul16532149133815"></a><a name="ul16532149133815"></a><ul id="ul16532149133815"><li>When inputs is a tensor, inputs_info must be a dict.</li><li>When inputs is list[tensor], inputs_info must be list[dict].</li><li>When inputs is None, each element of inputs_info must contain at least [shape, dtype].</li></ul>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p268717140308"><a name="p268717140308"></a><a name="p268717140308"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p1111845113020"><a name="p1111845113020"></a><a name="p1111845113020"></a>Optional parameter.</p>
</td>
...
<div class="note" id="note103734543279"><a name="note103734543279"></a><a name="note103734543279"></a><span class="notetitle"> NOTE: </span><div class="notebody"><p id="p4177193217280"><a name="p4177193217280"></a><a name="p4177193217280"></a>This input parameter has a constraint relationship with inputs:</p>
<a name="ul71771332122810"></a><a name="ul71771332122810"></a><ul id="ul71771332122810"><li>When outputs is a tensor, outputs_info must be a dict.</li><li>When outputs is list[tensor], outputs_info must be list[dict].</li><li>When outputs is None, each element of outputs_info must contain at least [shape, dtype].</li></ul>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p7424424103114"><a name="p7424424103114"></a><a name="p7424424103114"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p343822113116"><a name="p343822113116"></a><a name="p343822113116"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.27%" headers="mcps1.1.5.1.4 "><p id="p15489104015310"><a name="p15489104015310"></a><a name="p15489104015310"></a>Operator attributes used by the tiling function.</p>
<p id="p153601257151012"><a name="p153601257151012"></a><a name="p153601257151012"></a>Data Type: dict or list.</p>
<div class="note" id="note098955612145"><a name="note098955612145"></a><a name="note098955612145"></a><span class="notetitle"> NOTE: </span><div class="notebody"><a name="ul128741250201618"></a><a name="ul128741250201618"></a><ul id="ul128741250201618"><li>For the dict format, keys and values can only contain uppercase and lowercase English letters, digits, and underscores.<pre class="screen" id="screen196732811517"><a name="screen196732811517"></a><a name="screen196732811517"></a>{
  "a1": 1,
  "a2": False,
  "a3": "ssss",
  "a4": 1.2,
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p611375714315"><a name="p611375714315"></a><a name="p611375714315"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.5.1.2 "><p id="p0700152183213"><a name="p0700152183213"></a><a name="p0700152183213"></a>Input</p>
</td>
...
<table><thead align="left"><tr id="row144730589332"><th class="cellrowborder" valign="top" width="20.82%" id="mcps1.1.3.1.1"><p id="p647365853320"><a name="p647365853320"></a><a name="p647365853320"></a>Parameter Name</p>
</th>
<th class="cellrowborder" valign="top" width="79.17999999999999%" id="mcps1.1.3.1.2"><p id="p4473158193314"><a name="p4473158193314"></a><a name="p4473158193314"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="79.17999999999999%" headers="mcps1.1.3.1.2 "><p id="p467339193415"><a name="p467339193415"></a><a name="p467339193415"></a>The number of cores configured by the user's tiling function.</p>
<p id="p788513743715"><a name="p788513743715"></a><a name="p788513743715"></a>Data Type: int.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="79.17999999999999%" headers="mcps1.1.3.1.2 "><p id="p9719951019"><a name="p9719951019"></a><a name="p9719951019"></a>This value is the workspace size requested by the user plus 78,643,200 Bytes reserved by the msKL tool.</p>
<p id="p15483103110375"><a name="p15483103110375"></a><a name="p15483103110375"></a>Data Type: int.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="79.17999999999999%" headers="mcps1.1.3.1.2 "><p id="p511534133518"><a name="p511534133518"></a><a name="p511534133518"></a>Stores tiling_data for calling the Kernel function.</p>
<p id="p09351309407"><a name="p09351309407"></a><a name="p09351309407"></a>Data Type: numpy.array.</p>
</td>
</tr>
...
<th class="cellrowborder" valign="top" width="10.07%" id="mcps1.1.5.1.2"><p id="zh-cn_topic_0000001693276536_p1769255516412"><a name="zh-cn_topic_0000001693276536_p1769255516412"></a><a name="zh-cn_topic_0000001693276536_p1769255516412"></a>Input/Output</p>
</th>
<th class="cellrowborder" valign="top" width="7.5200000000000005%" id="mcps1.1.5.1.3"><p id="p1024820378356"><a name="p1024820378356"></a><a name="p1024820378356"></a>Required</p>
</th>
<th class="cellrowborder" valign="top" width="65.25%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p858655320395"><a name="p858655320395"></a><a name="p858655320395"></a>Path to the operator's kernel.o file. It can be found by executing the <strong id="b23211229105614"><a name="b23211229105614"></a><a name="b23211229105614"></a>find . -name '*.o'</strong> command in the project directory.</p>
<p id="p960565114599"><a name="p960565114599"></a><a name="p960565114599"></a>Data Type: str.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.07%" headers="mcps1.1.5.1.2 "><p id="zh-cn_topic_0000001693276536_p2076172220574"><a name="zh-cn_topic_0000001693276536_p2076172220574"></a><a name="zh-cn_topic_0000001693276536_p2076172220574"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p17248203712356"><a name="p17248203712356"></a><a name="p17248203712356"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p1464205919597"><a name="p1464205919597"></a><a name="p1464205919597"></a>Operator type. Can be set to vec, cube, or mix.</p>
<p id="p4807856193812"><a name="p4807856193812"></a><a name="p4807856193812"></a>If this parameter is not configured, the msKL tool may fail to obtain it. Therefore, manual assignment is recommended.</p>
<p id="p16255183291"><a name="p16255183291"></a><a name="p16255183291"></a>Data Type: str.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.07%" headers="mcps1.1.5.1.2 "><p id="p126964817386"><a name="p126964817386"></a><a name="p126964817386"></a>Input</p>
</td>
...
<th class="cellrowborder" valign="top" width="33.33333333333333%" id="mcps1.2.4.1.2"><p id="p1120465195716"><a name="p1120465195716"></a><a name="p1120465195716"></a>Input/Output</p>
</th>
<th class="cellrowborder" valign="top" width="33.33333333333333%" id="mcps1.2.4.1.3"><p id="p22041751155717"><a name="p22041751155717"></a><a name="p22041751155717"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p76621730125717"><a name="p76621730125717"></a><a name="p76621730125717"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0000001821790281_p1735018438911"><a name="zh-cn_topic_0000001821790281_p1735018438911"></a><a name="zh-cn_topic_0000001821790281_p1735018438911"></a>NPU device ID, which sets the ID of the <span id="zh-cn_topic_0000001821790281_ph173501343695"><a name="zh-cn_topic_0000001821790281_ph173501343695"></a><a name="zh-cn_topic_0000001821790281_ph173501343695"></a>Ascend AI Processor</span> for running ST test cases.</p>
<p id="p18525496107"><a name="p18525496107"></a><a name="p18525496107"></a>Data Type: int.</p>
<p id="zh-cn_topic_0000001821790281_p1350943597"><a name="zh-cn_topic_0000001821790281_p1350943597"></a><a name="zh-cn_topic_0000001821790281_p1350943597"></a>If this parameter is not set, it defaults to 0.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p1166219306572"><a name="p1166219306572"></a><a name="p1166219306572"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p188921897918"><a name="p188921897918"></a><a name="p188921897918"></a>In camodel simulation scenarios, a longer timeout period needs to be set by default. Setting it to -1 means no limit.</p>
<p id="p20887821121219"><a name="p20887821121219"></a><a name="p20887821121219"></a>Data Type: int.</p>
<p id="p9662123095717"><a name="p9662123095717"></a><a name="p9662123095717"></a>Unit: ms, default value is 300000.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p67021811135816"><a name="p67021811135816"></a><a name="p67021811135816"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p157021311165815"><a name="p157021311165815"></a><a name="p157021311165815"></a>Number of repeated runs, default value is 1.</p>
<p id="p1241342821215"><a name="p1241342821215"></a><a name="p1241342821215"></a>Data Type: int.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p948945315490"><a name="p948945315490"></a><a name="p948945315490"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p2048910536495"><a name="p2048910536495"></a><a name="p2048910536495"></a>Reserved Parameter.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p79201158154917"><a name="p79201158154917"></a><a name="p79201158154917"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p965862817502"><a name="p965862817502"></a><a name="p965862817502"></a>Reserved Parameter.</p>
</td>
</tr>
</tbody>
</table>
...
<th class="cellrowborder" valign="top" width="7.5200000000000005%" id="mcps1.1.5.1.3"><p id="p13941118163617"><a name="p13941118163617"></a><a name="p13941118163617"></a>Required</p>
</th>
<th class="cellrowborder" valign="top" width="65.25%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a>Description</p>
</th>
</tr>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p174230102515"><a name="p174230102515"></a><a name="p174230102515"></a>Required Parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000001693276536_p8761822125710"><a name="zh-cn_topic_0000001693276536_p8761822125710"></a><a name="zh-cn_topic_0000001693276536_p8761822125710"></a>Search space definition.</p>
<p id="p960565114599"><a name="p960565114599"></a><a name="p960565114599"></a>Data Type: list[dict].</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p153941818143617"><a name="p153941818143617"></a><a name="p153941818143617"></a>Optional Parameter.</p>
</td>
...
<td class="cellrowborder" valign="top" width="10.07%" headers="mcps1.1.5.1.2 "><p id="p226994833814"><a name="p226994833814"></a><a name="p226994833814"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p939416182367"><a name="p939416182367"></a><a name="p939416182367"></a>Optional Parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p1519610221383"><a name="p1519610221383"></a><a name="p1519610221383"></a>List of Device IDs. Currently, only single-Device mode is supported. If multiple Device IDs are provided, only the first one takes effect.</p>
<p id="p198371282219"><a name="p198371282219"></a><a name="p198371282219"></a>Default Value: [0].</p>
</td>
</tr>
</tbody>
</table>
...
<th class="cellrowborder" valign="top" width="7.5200000000000005%" id="mcps1.1.5.1.3"><p id="p124405383374"><a name="p124405383374"></a><a name="p124405383374"></a>Required</p>
</th>
<th class="cellrowborder" valign="top" width="65.25%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a>Description</p>
</th>
</tr>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p1667583410378"><a name="p1667583410378"></a><a name="p1667583410378"></a>Optional Parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p115678181496"><a name="p115678181496"></a><a name="p115678181496"></a>Specifies the File Path for generating the Kernel-side code delivery.</p>
<p id="p1244041710497"><a name="p1244041710497"></a><a name="p1244041710497"></a>Data Type: str.</p>
<p id="p15376846501"><a name="p15376846501"></a><a name="p15376846501"></a>Defaults to _gen_launch.cpp.</p>
</td>
</tr>
</tbody>
</table>
...
<th class="cellrowborder" valign="top" width="7.5200000000000005%" id="mcps1.1.5.1.3"><p id="p3254165893717"><a name="p3254165893717"></a><a name="p3254165893717"></a>Required</p>
</th>
<th class="cellrowborder" valign="top" width="65.25%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a>Description</p>
</th>
</tr>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p12254195811376"><a name="p12254195811376"></a><a name="p12254195811376"></a>Required parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p1244041710497"><a name="p1244041710497"></a><a name="p1244041710497"></a>Script used for template library Kernel compilation.</p>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p1625415883718"><a name="p1625415883718"></a><a name="p1625415883718"></a>Required parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p2330112281017"><a name="p2330112281017"></a><a name="p2330112281017"></a>File path of the Kernel code delivery generated by the code_gen interface. Generally, the return value of the code_gen interface is used directly.</p>
<p id="p1235517611263"><a name="p1235517611263"></a><a name="p1235517611263"></a>Data Type: str.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.07%" headers="mcps1.1.5.1.2 "><p id="p648702213274"><a name="p648702213274"></a><a name="p648702213274"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p15254135823713"><a name="p15254135823713"></a><a name="p15254135823713"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p3877449179"><a name="p3877449179"></a><a name="p3877449179"></a>Specifies the path of the executable file generated by compilation.</p>
<p id="p151642576716"><a name="p151642576716"></a><a name="p151642576716"></a>Data Type: str.</p>
<p id="p862114551676"><a name="p862114551676"></a><a name="p862114551676"></a>Default Value: _gen_module.so.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.07%" headers="mcps1.1.5.1.2 "><p id="p1279142712719"><a name="p1279142712719"></a><a name="p1279142712719"></a>Input</p>
</td>
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p7254858113719"><a name="p7254858113719"></a><a name="p7254858113719"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p599012311160"><a name="p599012311160"></a><a name="p599012311160"></a>When enabled, compilation is not executed, and the file specified by output_bin_path is loaded instead.</p>
<p id="p583712186617"><a name="p583712186617"></a><a name="p583712186617"></a>Data Type: bool.</p>
<p id="p19100819617"><a name="p19100819617"></a><a name="p19100819617"></a>Default Value: False.</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0000001821790281_p1735018438911"><a name="zh-cn_topic_0000001821790281_p1735018438911"></a><a name="zh-cn_topic_0000001821790281_p1735018438911"></a>NPU device ID, which sets the ID of the <span id="zh-cn_topic_0000001821790281_ph173501343695"><a name="zh-cn_topic_0000001821790281_ph173501343695"></a><a name="zh-cn_topic_0000001821790281_ph173501343695"></a>Ascend AI Processor</span> for running ST test cases.</p>
<p id="p18525496107"><a name="p18525496107"></a><a name="p18525496107"></a>Data Type: int.</p>
<p id="zh-cn_topic_0000001821790281_p1350943597"><a name="zh-cn_topic_0000001821790281_p1350943597"></a><a name="zh-cn_topic_0000001821790281_p1350943597"></a>Defaults to 0 if this parameter is not set.</p>
</td>
</tr>
<tr id="row11662530125710"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.1 "><p id="p18662153015573"><a name="p18662153015573"></a><a name="p18662153015573"></a>timeout</p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p188921897918"><a name="p188921897918"></a><a name="p188921897918"></a>A longer timeout period needs to be set by default in camodel simulation scenarios. Setting it to -1 means no limit.</p>
<p id="p20887821121219"><a name="p20887821121219"></a><a name="p20887821121219"></a>Data Type: int.</p>
<p id="p9662123095717"><a name="p9662123095717"></a><a name="p9662123095717"></a>Unit: ms. The default value is 300000.</p>
</td>
</tr>
<tr id="row1770213117585"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.1 "><p id="p11702181115584"><a name="p11702181115584"></a><a name="p11702181115584"></a>repeat</p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p157021311165815"><a name="p157021311165815"></a><a name="p157021311165815"></a>Number of repeated runs. The default value is 1.</p>
<p id="p1241342821215"><a name="p1241342821215"></a><a name="p1241342821215"></a>Data Type: int.</p>
</td>
</tr>
...
<th class="cellrowborder" valign="top" width="7.5200000000000005%" id="mcps1.1.5.1.3"><p id="p9836113793820"><a name="p9836113793820"></a><a name="p9836113793820"></a>Required</p>
</th>
<th class="cellrowborder" valign="top" width="65.25%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a>Description</p>
</th>
</tr>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p3836937123816"><a name="p3836937123816"></a><a name="p3836937123816"></a>Required parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000001693276536_p8761822125710"><a name="zh-cn_topic_0000001693276536_p8761822125710"></a><a name="zh-cn_topic_0000001693276536_p8761822125710"></a>Search space definition.</p>
<p id="p960565114599"><a name="p960565114599"></a><a name="p960565114599"></a>Data Type: list[dict].</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p283633723813"><a name="p283633723813"></a><a name="p283633723813"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p7623626182018"><a name="p7623626182018"></a><a name="p7623626182018"></a>Number of device warm-up iterations before performance collection.</p>
<p id="p4807856193812"><a name="p4807856193812"></a><a name="p4807856193812"></a>Default Value: 5, with a value range of integers from 1 to 500.</p>
</td>
</tr>
</tbody>
</table>
...
<th class="cellrowborder" valign="top" width="7.5200000000000005%" id="mcps1.1.5.1.3"><p id="p147749211392"><a name="p147749211392"></a><a name="p147749211392"></a>Required</p>
</th>
<th class="cellrowborder" valign="top" width="65.25%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a><a name="zh-cn_topic_0000001693276536_zh-cn_topic_0122830089_p173881843143514"></a>Description</p>
</th>
</tr>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p187749218396"><a name="p187749218396"></a><a name="p187749218396"></a>Required parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p1244041710497"><a name="p1244041710497"></a><a name="p1244041710497"></a>Script file path used to compile the application to be tuned.</p>
<p id="p83481217117"><a name="p83481217117"></a><a name="p83481217117"></a>Data Type: str.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p19618112002"><a name="p19618112002"></a><a name="p19618112002"></a>Required parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p2330112281017"><a name="p2330112281017"></a><a name="p2330112281017"></a>Code file path.</p>
<p id="p1235517611263"><a name="p1235517611263"></a><a name="p1235517611263"></a>Data Type: str.</p>
</td>
</tr>
<tr id="row2446191225310"><td class="cellrowborder" valign="top" width="17.16%" headers="mcps1.1.5.1.1 "><p id="p1844691215313"><a name="p1844691215313"></a><a name="p1844691215313"></a>output_bin_path</p>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p577417210399"><a name="p577417210399"></a><a name="p577417210399"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p3877449179"><a name="p3877449179"></a><a name="p3877449179"></a>Specifies the path of the executable file generated by compilation.</p>
<p id="p151642576716"><a name="p151642576716"></a><a name="p151642576716"></a>Data Type: str.</p>
<p id="p862114551676"><a name="p862114551676"></a><a name="p862114551676"></a>Default Value: _gen_executable.</p>
</td>
</tr>
<tr id="row16446912115316"><td class="cellrowborder" valign="top" width="17.16%" headers="mcps1.1.5.1.1 "><p id="p1244615127537"><a name="p1244615127537"></a><a name="p1244615127537"></a>use_cache</p>
</td>
...
<td class="cellrowborder" valign="top" width="7.5200000000000005%" headers="mcps1.1.5.1.3 "><p id="p197749212396"><a name="p197749212396"></a><a name="p197749212396"></a>Optional parameter.</p>
</td>
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p599012311160"><a name="p599012311160"></a><a name="p599012311160"></a>When enabled, compilation is not executed, and the file specified by output_bin_path is loaded instead.</p>
<p id="p583712186617"><a name="p583712186617"></a><a name="p583712186617"></a>Data Type: bool.</p>
<p id="p19100819617"><a name="p19100819617"></a><a name="p19100819617"></a>Default Value: False.</p>
<p id="p427716281"><a name="p427716281"></a><a name="p427716281"></a>NOTE: When using the msDebug tool to invoke the compile interface, use_cache=True must be configured.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.07%" headers="mcps1.1.5.1.2 "><p id="p7755621182918"><a name="p7755621182918"></a><a name="p7755621182918"></a>Input</p>
</td>
...
<td class="cellrowborder" valign="top" width="65.25%" headers="mcps1.1.5.1.4 "><p id="p127552021182913"><a name="p127552021182913"></a><a name="p127552021182913"></a>Reserved parameter.</p>
</td>
</tr>
</tbody>
</table>
