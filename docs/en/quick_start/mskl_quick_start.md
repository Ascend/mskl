...
This chapter assumes that you have completed the full workflow in the <a href="https://gitcode.com/Ascend/msot/blob/26.1.0/docs/en/quick_start/op_tool_quick_start.md" target="_blank">Operator Development Toolchain Quick Start</a>. If you have not yet done so, you are advised to complete the guide first for a better learning experience.
...
Follow the instructions in Section 2.3 of <a href="https://gitcode.com/Ascend/msot/blob/26.1.0/docs/en/quick_start/op_tool_quick_start.md#23-developing-and-building-the-operator-project-msopgen" target="_blank">Operator Development Toolchain Quick Start</a> to prepare the operator project.
