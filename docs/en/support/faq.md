...
2. Complete the full environment configuration by following the [Operator Tool Development Environment Installation Guide](https://gitcode.com/Ascend/msot/blob/26.1.0/docs/en/common/dev_env_setup.md).
