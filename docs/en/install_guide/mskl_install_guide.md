...
Configure the environment according to the following document: [Operator Tool Development Environment Setup Guide](https://gitcode.com/Ascend/msot/blob/26.0.0/docs/en/common/dev_env_setup.md).

#### 2.3.2 Building the whl Package

- Clone this repository.

    ```sh
    git clone https://gitcode.com/Ascend/mskl.git -b 26.0.0
    ```
...
#### 2.3.3 Installing the whl Package
